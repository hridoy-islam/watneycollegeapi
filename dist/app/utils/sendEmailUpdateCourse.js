...
exports.sendEmailUpdateCourse = void 0;
const nodemailer_1 = __importDefault(require("nodemailer"));
const ejs_1 = __importDefault(require("ejs"));
require("dotenv").config();
const { google } = require("googleapis");
const sendEmailUpdateCourse = (to, template, subject, name, email, courseName, termName, previousCourseName) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.sendEmailUpdateCourse = sendEmailUpdateCourse;
